...
window.addEventListener("scroll", function () {
    ...
    for (var i = 0; i < 16; i++) {
        if (i === 17 && arr[16].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 16 && arr[15].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 14 && arr[13].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 13 && arr[12].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 12 && arr[11].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 11 && arr[10].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 10 && arr[9].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 9 && arr[8].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
        else if (i === 8 && arr[7].bottom < changeBg) {
            images[i].classList.remove("fade-out");
        }
